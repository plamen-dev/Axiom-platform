...
EXPECTED_AXIOM_COMMANDS = {
    ...
    "test-levels", "tools", "discovery-loop",
    "trusted-capabilities", "trusted-capability",
    ...
    "repair-decision-create", "repair-decisions",
    ...
    "config-execute", "config-execution-show", "config-execution-export",
    ...
    "capability-show", "capability-export",
    "capability-input-create", "capability-inputs",
    "capability-input-show", "capability-input-export",
    "capability-output-create", "capability-outputs",
    "capability-output-show", "capability-output-export",
    "capability-report-create", "capability-reports",
    "capability-report-show", "capability-report-export",
    "capability-failure-create", "capability-failures",
    ...
    "capability-history-create", "capability-history-show",
    ...
    "recovery-execution-create", "recovery-execution-show",
    "recovery-execution-export",
    "session-memory-create", "session-memory-show",
    ...
    "github-import", "github-import-backfill", "github-import-show",
    ...
    "capability-file-create", "capability-files",
    ...
    "atlas",
    "simulated-adapter-run", "simulation-harness-run",
    ...
    "execution-constraint-create", "execution-constraints",
    ...
    "execution-step-create", "execution-steps",
    "execution-step-show", "execution-step-export",
    "execution-attempt-v2-create", "execution-attempts-v2",
    "execution-attempt-v2-show", "execution-attempt-v2-export",
    "execution-result-create", "execution-results",
    "execution-result-show", "execution-result-export",
    "execution-artifact-create", "execution-artifacts",
    "execution-artifact-show", "execution-artifact-export",
    "execution-report-create", "execution-reports",
    "execution-report-show", "execution-report-export",
}
